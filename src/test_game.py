...
class GameTest(unittest.TestCase):
    ...
    def test_moves_impossible(self):
        grid = move(DEFAULT_GRID, Move.BOTTOM)
        self.assertEqual(grid, DEFAULT_GRID)        
